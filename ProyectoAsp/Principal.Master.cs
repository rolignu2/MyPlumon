...
namespace ProyectoAsp
{
    public partial class Principal : System.Web.UI.MasterPage
    {
        ...
        public void SetUsuario_data()
        {
            try
            {
                ...
                else
                {
                    ...
                    var esx =  ProyectoAsp.Clases.Seguridad.HttpUrl + "/images/avatar/" + Imagen ;
        ...
        {
            t1.HRef = "CursosCerrados.aspx";
            t2.HRef = "BuscarCursos.aspx";
            t3.HRef = "TodoCursos.aspx";
            t1.Visible = false;
            t3.Visible = false;
            //**************************************************//
        ...
        public void SetCursoTutor()
        {
            t1.HRef = "AddCurso.aspx";
            t2.HRef = "BuscarCursos.aspx";
            t3.HRef = "OtrosCursos.aspx";
            //**************************************************//
        }
