<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" ValidateRequest="false"  CodeBehind="add_doc_periodo.aspx.cs" Inherits="ProyectoAsp.Formulario_web112" %>
				...
				<div class="half-size-column fr">
					...
					<div class="content-module">
						...
						<div class="content-module-heading cf">
							...
							<h3 class="fl">Otros Archivos de este periodo</h3>
						...
						<div class="content-module-main cf">
							...
							<div class="half-size-column fl">
								...
								<ul class="regular-ul" runat="server" id="otrosArchivos1">
							...
							<div class="half-size-column fr" >
								...
								<ul class="custom-ul" runat="server" id="otrosArchivos2">
