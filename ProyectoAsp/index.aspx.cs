...
namespace ProyectoAsp
{
    public partial class Formulario_web11 : System.Web.UI.Page
    {
        ...
        private void Get_Usuario_Cursos()
        {
            ...
            {
                div_tabla.InnerHtml = "<div class='"
                    + new Cssclass().informacion + "'<p>Usted no tiene Cursos , si desea estar en uno puede ir a buscar cursos o click en "
                    + "&nbsp&nbsp<a href='BuscarCursos.aspx'>Cursos</a></p>"; 
