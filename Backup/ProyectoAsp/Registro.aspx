...
<p align="center" style="font-size: small; color: #000000">
    ...
    <p class="blue" 
        ...
        Paso 1 (Datos personales)<br /><br /><br />
</p>
    <p align="center" style="font-size: small; color: #000000">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="txtmail" runat="server" CssClass="round full-width-input" 
            Height="24px" Width="202px"></asp:TextBox>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
            ErrorMessage="Se requiere un correo" ControlToValidate="txtmail" 
