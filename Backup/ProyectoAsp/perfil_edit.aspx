        ...
        <em>En dado caso te equivocastes en tu cumpleaños puedes correjirlo</em>
						...
						<div class="half-size-column fr">
								...
								<fieldset>
                                   ...
                                   <p></p>
                                    <label for="dropdown-actions">PAIS</label>
                                    <p class="form-error-input">
					...
					<div class="content-module">
						...
						<div class="content-module-main">
							...
							<div class="warning-box round">
                                <label>Cambia Tu imagen o avatar</label>
                                <asp:Image ID="Image1" runat="server" Height="147px" Width="174px" />
                                <asp:FileUpload ID="archivoImagen" runat="server" Height="26px" Width="274px" />
                                <asp:Button ID="cmd_imagen_2" runat="server" Text="Cambiar Imagen" 
                                    CssClass="round blue ic-right-arrow" onclick="cmd_imagen_2_Click" 
                                    ValidationGroup="archivoImagen"  />
                            </div>
				            ...
				            <p>
	                          ...
	                          <p></p>
									<p>
                                      ...
                                      <p></p>
				          <p align="center">
                                <asp:Button ID="cmd_contra" runat="server" Text="Guardar Contraseña" 
